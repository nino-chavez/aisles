...
<style>
	...
	@media (max-width: 760px) { .kc-reference-capability-matrix__surfaces { grid-template-columns:1fr; } .kc-reference-capability-matrix header { align-items:flex-start; flex-direction:column; } .kc-reference-capability-matrix header span { max-width:100%; white-space:normal; overflow-wrap:anywhere; } }
</style>
