...
export const load: PageServerLoad = async ({ params, parent }) => {
	...
	if (chromeMode !== 'reference' || !SUBTYPES.has(params.subtype)) throw error(404, 'Not found');
	...
	return {
		kibbleCheckout: { subtype, availabilityMessage, recipeId: KIBBLE_REFERENCE_CONTRACT.recipes.checkout.id },
	};
};
