...
vi.mock('$lib/brand/composition-policy', () => ({ KIBBLE_OBSERVE_PLP_PRODUCT_RANKING_ROUTE: '/category/dog-food', KIBBLE_OBSERVE_PLP_PRODUCT_RANKING_SORT: 'FEATURED', getKibbleObservePlpProductRankingModelPolicyDescriptor: () => ({ policyVersion: 'plp-assist-v1' }) }));
